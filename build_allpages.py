...
# ============ TAG SYSTEM ============
VOC={
'Afghanistan':['afghanistan','talebani','taliban'],'Donne':['persecuzione di genere'],
...
TAGNAME={
'Afghanistan':{'it':'Afghanistan','en':'Afghanistan','fr':'Afghanistan','de':'Afghanistan','es':'Afganistán','pt':'Afeganistão','tr':'Afganistan','zh':'阿富汗','ar':'أفغانستان','he':'אפגניסטן'},
'Donne':{'it':'Donne','en':'Women','fr':'Femmes','de':'Frauen','es':'Mujeres','pt':'Mulheres','tr':'Kadınlar','zh':'妇女','ar':'المرأة','he':'נשים'},
